...
def build_match_row(
    ...
    # --- Issue #85: venue-split form ---

    home_home_form_w5 = tracker.form_by_venue(home_team, home=True, window=5)
    home_away_form_w5 = tracker.form_by_venue(home_team, home=False, window=5)
    away_home_form_w5 = tracker.form_by_venue(away_team, home=True, window=5)
    away_away_form_w5 = tracker.form_by_venue(away_team, home=False, window=5)
    ...
    return {
        ...
        # Issue #85: venue-split form
        "home_home_form_w5": float(home_home_form_w5),
        "home_away_form_w5": float(home_away_form_w5),
        "away_home_form_w5": float(away_home_form_w5),
        "away_away_form_w5": float(away_away_form_w5),
        "home_venue_form_diff": float(home_home_form_w5 - home_away_form_w5),
        "away_venue_form_diff": float(away_home_form_w5 - away_away_form_w5),
